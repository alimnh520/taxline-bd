            ...
            <div className="w-[400px] h-auto flex flex-col justify-start">
                ...
                <div className="w-full h-96 border border-[#172d13] mt-5 overflow-hidden relative group">
                    <div className="marquee-container">
                        <div className="text-sm flex flex-col border-b border-t border-[#172d13] p-2 gap-y-1 hover:bg-[#172d13b7] bg-white group">
                            <Link href="" className="text-[#172d13] hover:text-white leading-7 group-hover:underline">
                        ...
                        <div className="text-sm flex flex-col border-b border-[#172d13] p-2 gap-y-1 hover:bg-[#172d13b7] bg-white group">
                            <Link href="" className="text-[#172d13] hover:text-white leading-7 group-hover:underline">
