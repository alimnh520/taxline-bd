...
export const BusinessCalculator = () => {
    return (
        <div className="w-full h-auto flex flex-col items-start gap-y-8 px-5 mt-8">
            <div className="w-full h-auto flex items-start justify-between gap-x-7">

                <div className="w-[330px] h-auto flex flex-col justify-start">
                    <div className="ribbon2 text-center py-2 text-white text-lg font-semibold rounded-md shadow-sm"><p>ব্যবসায়ে অনুমোদনযোগ্য খরচ সম্পর্কিত ক্যালকুলেটর</p></div>
                ...
                <div className="flex-1 h-auto">
                    ...
                    <div className="w-full h-[280px] mt-5 grid grid-cols-6 grid-rows-2 gap-3 px-12">
                        <Link href="" className="bg-[#172d13b7] h-full w-full rounded-t-xl rounded-b-[20px] hover:scale-105 hover:shadow-xl border border-blue-100 transition-all duration-300 flex flex-col items-center justify-center overflow-hidden">
            ...
            >
                <SwiperSlide className="min-w-60 max-h-52 flex border border-[#172d13] rounded-xl bg-[#172d13] shadow hover:shadow-lg flex-col items-start">
                    <div className="h-40 w-full bg-gradient-to-br from-orange-100 to-blue-100 rounded-t-xl"></div>
                    <p className="flex-1 flex items-center justify-start text-sm text-white font-medium">
                ...
                <SwiperSlide className="min-w-60 max-h-52 flex border border-[#172d13] rounded-xl bg-[#172d13] shadow hover:shadow-lg flex-col items-start">
                    <div className="h-40 w-full bg-gradient-to-br from-orange-100
                     to-blue-100 rounded-t-xl"></div>
                    <p className="flex-1 flex items-center justify-start text-sm px-3 py-2 text-white font-medium">
                        শেয়ার ক্রয়বিক্রয় ব্যবসা হতে প্রাপ্ত আয় ই-রিটার্ন সিস্টেমে কিভাবে...
                    </p>
                </SwiperSlide>
            ...
            <Link href="" className="px-4 py-3 mt-3 self-center font-semibold text-sm bg-linear-to-r from-[#172d13] to-[#172d13b7] hover:shadow-2xl hover:bg-[#172d13] rounded-lg shadow text-white transition-all duration-300">View More Video</Link>
