    ...
    const sendEmail = async () => {
        try {
            ...
            if (!username || !email || !phone) {
                setMessage("অনুগ্রহ করে নাম, মোবাইল ও ইমেইল পূরণ করুন!");
                setStatus("error");
                return;
            }
            ...
            setIsSend(data.success ? true : false);
        } catch (error) {
            console.error(error);
            ...
            <div className="max-w-6xl mx-auto px-4 py-10 grid md:grid-cols-2 gap-10 items-start">
                ...
                <div className="space-y-3">
                    ...
                    <input
                        ...
                        className="border border-gray-300 rounded-md px-4 py-2 w-full outline-none focus:border-green-600"
                    />
                    ...
                    {!isSend && (<div className="flex mb-3">
                        <input
                            type="email"
                            value={email}
                ...
                ${status === "success"
                    ...
                    <p className="text-sm text-gray-800">
                        ...
                        <Link href="/components/login" className="text-green-700 font-semibold">
                            লগইন করুন
                        </Link>
                    </p>
                </div>
                ...
                {/* Right Banner */}
                <div className="border h-auto sm:h-72 sm:px-5 rounded-lg shadow-sm flex flex-col sm:flex-row items-center justify-center px-0 sm:justify-between bg-gradient-to-r from-green-700 to-green-600 text-white relative overflow-hidden">
