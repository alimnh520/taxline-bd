...
export function Section113() {
    ...
    return (
        <div className="col-md-6 order-1 order-md-2" id="sectionContent" >
            ...
            <h1 className="my-1 font-bold text-2xl py-1">পরিবহন মাশুল ফরওয়ার্ড এজেন্সি কমিশন হইতে কর কর্তন</h1>
            <strong className="text-sm">ধারা : ১১৩</strong>
                ...
                <div className="col-md-12 mt-6 text-sm">
                    <div className="w-full">
                        ...
                        <div className={`text-justify ${selectedYear === '1' ? 'block' : 'hidden'} space-y-4`}>
                            ...
                            <p>মন্তব্য : </p>
                            <p className="text-red-600">আলোচ্য করবর্ষে উক্ত আইনটি বিলুপ্ত করা হয়েছে</p>

                        </div>
                        <div className={`text-justify ${selectedYear === '2' ? 'block' : 'hidden'} space-y-4`}>

                            <p className="text-justify">
                                পরিবহন মাশুল ফরওয়ার্ড এজেন্সি কমিশনের কারণে কোনো অর্থ পরিশোধের জন্য দায়িত্বপ্রাপ্ত কোনো ব্যক্তি, প্রাপককে অর্থ প্রদান বা জমার সময়, প্রদেয় মোট অর্থের ১৫% (পনেরো শতাংশ) হারে কর কর্তন করিবেন।
                            </p>
                        </div>
                    </div>
