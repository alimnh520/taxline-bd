...
export function Section118() {
    ...
    return (
        <div className="col-md-6 order-1 order-md-2" id="sectionContent">
            ...
            <strong className="text-sm">ধারা : ১১৮</strong>
                ...
                <div className="col-md-12 mt-6 text-sm">
                    <div className="w-full text-justify space-y-4">
                        <p className="text-justify">
                            লটারি, শব্দজট, কার্ড গেইম, অনলাইন গেইম অথবা এইরূপ যেকোনো প্রকৃতির খেলায় জয় লাভ করিয়া কোনো অর্থ প্রাপ্ত হইলে অর্থ পরিশোধের জন্য দায়িত্বপ্রাপ্ত ব্যক্তি, উক্তরূপ অর্থ প্রদানকালে, ২০% (বিশ শতাংশ) হারে কর কর্তন করিবেন।
                        </p>
                        <p className="text-justify">
                            ব্যাখ্যা।- “যেকোনো পরিমাণ"  অভিব্যক্তিটির অর্থ কোনো পণ্য বা সম্পত্তির মূল্য যেখানে উক্ত বিজয়ীর হিসাবে নগদে অর্থ বা সম্পদ দ্বারা প্রদান করা হয়।
                        </p>
                    </div>
                </div>
            </div>
