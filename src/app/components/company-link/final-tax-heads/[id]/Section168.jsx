...
export function Section168() {
    ...
    return (
        <div className="col-md-6 order-1 order-md-2" id="sectionContent">
            ...
            <p className="text-justify">যেকোনো  ব্যক্তি করদাতার বাণিজ্যিকভাবে পরিচালিত মোটরযান হতে আয়ের বিপরীতে সংগৃহীত  কর চূড়ান্ত করদায় হিসেবে বিবেচিত।</p>
            ...
            <div className="row g-1">
                <div className="col-md-12 mt-6 text-sm">
                    <div className="w-full text-justify space-y-4">
                        ...
                        <br />
                        <br />
                        <p className="text-red-600">নোটঃ পরিগণিত আয়ের অধিক আয় প্রদর্শিত হলে উক্ত অধিক প্রদর্শিত উপর নিয়মিত হারে কর পরিশোধ করতে হবে।</p>
                        <br />
                        <br />
