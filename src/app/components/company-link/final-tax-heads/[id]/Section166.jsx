...
export function Section166() {
    ...
    return (
        <div className="col-md-6 order-1 order-md-2" id="sectionContent">
            ...
            <p className="text-justify">যেকোনো ব্যক্তি করদাতার রপ্তানির বিপরীতে প্রাপ্ত নগদ ভর্তুকির বিপরীতে কর্তিত কর চূড়ান্ত করদায় হিসেবে বিবেচিত।</p>
