...
export function Section163() {
    ...
    return (
        <div className="col-md-6 order-1 order-md-2" id="sectionContent">
            ...
            <strong className="text-sm">যেকোনো স্বাভাবিক ব্যক্তি করদাতার সম্পত্তির অধিগ্রহণ এর ক্ষতিপূরণ হতে অর্জিত মূলধনি আয়ের বিপরীতে কর্তিত কর চূড়ান্ত করদায় হিসেবে বিবেচিত।</strong>
            ...
            <div className="row g-1">
                <div className="col-md-12 mt-6 text-sm">
                    <div className="w-full text-justify space-y-4">
                        ...
                        <p className="text-red-600">১। ইতিপূর্বে ২০২৪-২০২৫ করবর্ষ পর্যন্ত এস.আর.ও নং-১৭-আইন/আয়কর-২৪/২০২৪ এর মাধ্যমে চূড়ান্ত করদায় ছিল, যা এস.আর.ও নং ১৫১-আইন/আয়কর-৬/২০২৫ এর মাধ্যমে বাতিল করা হয়েছে। </p>
                    </div>
                    <br />
