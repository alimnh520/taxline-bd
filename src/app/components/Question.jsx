            ...
            <div className="w-full flex flex-col sm:flex-row items-start justify-between gap-x-5">
                <div className="w-full h-auto mt-5 flex flex-col gap-y-1.5">
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question1 ? 'h-[1100px] sm:h-[800px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        <button className="bg-white hover:bg-[#dff3e9] text-[#00440c] transition-all duration-300 cursor-pointer w-full py-2.5 relative flex items-center justify-start px-3" onClick={() => {
                            setQuestion1(false)
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question2 ? 'h-[280px] sm:h-[180px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question3 ? 'h-[150px] sm:h-[110px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question4 ? 'h-[680px] sm:h-[480px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                ...
                <div className="w-full h-auto mt-5 flex flex-col gap-y-1.5">
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question5 ? 'h-[150px] sm:h-[120px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question6 ? 'h-[380px] sm:h-[280px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question7 ? 'h-[900px] sm:h-[630px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                    ...
                    <div className="w-full flex flex-col border border-[#17982f] overflow-hidden rounded-md ">
                        ...
                        <div className={`w-full flex flex-col gap-y-6 text-[15px] ${question8 ? 'h-[1380px] sm:h-[1080px] py-5 px-3 border-t' : 'h-0'} border-t-[#17982f] transition-all duration-300 `}>
                            <div>
